...
public final class giveanswers_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
	...
	if(session.getAttribute("username")!=null)
	{
      ...
      out.write("</select>\n");
      out.write("           <input type=\"submit\" name=\"b2\" value=\"Check\" >\n");
      out.write("        </form>\n");
      out.write("     \n");
      out.write("      ");
...
String sql="select * from questions where Subject='"+m+"';";
  ...
  out.println(rs.getString(3));
      ...
      out.write("\t\t\t\t</td>\t\n");
      out.write("                                \n");
      out.write("                                <td><button href=\"reply.jsp\">Reply</button>\n");
      out.write("                                </td>\n");
      out.write("                        \n");
      out.write("\t\t\t  </tr>\n");
      out.write("                               ");
