...
%></p>
  ...
  <option value="Distributed & Parallel Database">Distributed & Parallel Database</option>
           ...
           File Name:<input type="text" name="qfn" placeholder="Name with extention"><br>
           Correct Answer:<input type="text" name="ca" >
	...
	Connection con=null;
        	...
        	ResultSet rs;
                try{
                  ...
                  String f =request.getParameter("qfn");
                  String l =request.getParameter("qsub");
                  String a =request.getParameter("ca");
                  
                  String sql="insert into quiz values('"+l+"','"+a+"','"+f+"');";
			...
			if(res!=0)
                        {
                           session.setAttribute("qfnn",f);
                           session.setAttribute("qsub",l);
                            response.sendRedirect("uploadques.jsp");
                        }
                }
