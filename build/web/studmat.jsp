...
%></p>
  ...
  <option value="Distributed & Parallel Database">Distributed & Parallel Database</option>
           ...
           File Name:<input type="text" name="fn" >
           <input type="submit" name="b2" class="btn-primary" value="Upload" >
        </form>
	...
	Connection con=null;
        	...
        	ResultSet rs;
                try{
                  ...
                  String l =request.getParameter("sub");
                  
                  String sql="insert into stum values('"+f+"','"+l+"');";
			...
			if(res!=0)
                        {
                           session.setAttribute("fnn",f);
                           session.setAttribute("subb",l);
